...
public class GameCustomizerProvider implements CustomizerProvider {

    public final GameProject project;
    public static final String CUSTOMIZER_FOLDER_PATH
            = "Projects/info-lusito-mapeditor-game-project/Customizer";

    public GameCustomizerProvider(GameProject project) {
