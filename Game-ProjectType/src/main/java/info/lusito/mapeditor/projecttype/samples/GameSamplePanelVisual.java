...
public class GameSamplePanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";
    private final GameSampleWizardPanel panel;

    public GameSamplePanelVisual(GameSampleWizardPanel panel) {
        initComponents();
        this.panel = panel;
